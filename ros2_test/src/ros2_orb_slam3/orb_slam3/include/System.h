...
public:
    ...
    Sophus::SE3f TrackMonocular(const cv::Mat &im, const double &timestamp, const std::vector<cv::Point2f>& badPoints = std::vector<cv::Point2f>(), const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
