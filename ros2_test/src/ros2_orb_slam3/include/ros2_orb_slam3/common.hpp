...
{   
    ...
    private:
        ...
        std::string subBadPointsMsgName = "";
        ...
        rclcpp::Subscription<geometry_msgs::msg::PoseArray>::SharedPtr subBadPointMsg_subscription_;
        ...
        std::vector<cv::Point2f> badPoints;
        std::mutex mBadPointsMutex;
        ...
        void BadPoint_callback(const geometry_msgs::msg::PoseArray& msg);
